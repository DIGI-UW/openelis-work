/**
 * ARCHIVED 2026-09-10 — superseded by the inline-config model.
 *
 * This is the original admin-CRUD mockup for the Positivity Rate Report,
 * implementing a persisted PositivityConfig entity with an admin management
 * page (add/edit/deactivate). FRS v1.1 retired this model in favor of an
 * inline, ephemeral positivity definition configured at report-generation
 * time / widget-placement time. The canonical, registered mockup is now
 * designs/reports/positivity-rate.jsx (Carbon-styled, inline-only).
 *
 * Kept here for historical reference only. Not registered in MANIFEST.yaml
 * or mockup-viewer/src/App.jsx.
 */
