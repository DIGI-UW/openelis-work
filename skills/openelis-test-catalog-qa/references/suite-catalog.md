# Suite Catalog — test suites, phases, and route discovery

> The authoritative inventory of QA suites. Step 1/Step 3 read this. Detailed per-TC
> steps are derived from each suite row + the live app; richer external case docs (if any)
> live in the QA test repo (see `playwright-harness.md`).
>
