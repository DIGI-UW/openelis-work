...
Master index of all designs. Each feature has a co-located `.jsx` mockup and `.md` spec in the `designs/` folder.
...
| Test Catalog — Specimen Many-to-Many [Completed] | [test-catalog-specimen-mn.jsx](designs/admin-config/test-catalog-specimen-mn.jsx) · [preview](designs/admin-config/test-catalog-specimen-mn-preview.html) | [test-catalog-specimen-mn.md](designs/admin-config/test-catalog-specimen-mn.md) |
| Test Catalog Editor — Completion & Correction [Completed] | [test-catalog-editor-completion.jsx](designs/admin-config/test-catalog-editor-completion.jsx) · [preview](designs/admin-config/test-catalog-editor-completion.html) | [test-catalog-editor-completion.md](designs/admin-config/test-catalog-editor-completion.md) |
...
| Compliance Standards Administration [Completed] | [compliance-standards-admin.jsx](designs/admin-config/compliance-standards-admin.jsx) \| [preview](designs/admin-config/compliance-standards-admin.html) | [compliance-standards-admin.md](designs/admin-config/compliance-standards-admin.md) |
| Barcode Configuration [Completed] | [barcode-config.jsx](designs/admin-config/barcode-config.jsx) | [barcode-config.md](designs/admin-config/barcode-config.md) |
| Sample Type Multi-Domain Addendum [Completed] | [preview](designs/admin-config/sample-type-multi-domain-addendum.html) | [sample-type-multi-domain-addendum.md](designs/admin-config/sample-type-multi-domain-addendum.md) |
...
| Sample Type Management [Completed] | [sample-type-management.jsx](designs/admin-config/sample-type-management.jsx) | [sample-type-management.md](designs/admin-config/sample-type-management.md) |

## Vector Surveillance

| Feature | Mockup | Spec |
|---------|--------|------|
| Sample Type Domain Classification [Completed] | [sample-type-domain-classification.jsx](designs/admin-config/sample-type-domain-classification.jsx) | [sample-type-domain-classification.md](designs/admin-config/sample-type-domain-classification.md) |
...
| QuantStudio 5/7 Flex Field Mapping [Completed] | — | [quantstudio-field-mapping-spec-v131.md](designs/analyzer-integration/quantstudio-field-mapping-spec-v131.md) |
| QuantStudio 5/7 Flex Companion Guide [Completed] | — | [quantstudio-companion-guide-v10.md](designs/analyzer-integration/quantstudio-companion-guide-v10.md) |
...
| Analyzer Mapping Templates [Completed] | [analyzer-mapping-templates.jsx](designs/analyzer-integration/analyzer-mapping-templates.jsx) | [astm-addendum](designs/analyzer-integration/astm-analyzer-mapping-addendum.md), [hl7-addendum](designs/analyzer-integration/hl7-analyzer-mapping-addendum.md) |
| Flat File Analyzer Config [Completed] | [flat-file-analyzer-config.jsx](designs/analyzer-integration/flat-file-analyzer-config.jsx) | [flat-file-analyzer-config.md](designs/analyzer-integration/flat-file-analyzer-config.md) |
| HL7 Analyzer Mapping [Completed] | [hl7-analyzer-mapping.jsx](designs/analyzer-integration/hl7-analyzer-mapping.jsx) | [hl7-addendum](designs/analyzer-integration/hl7-analyzer-mapping-addendum.md) |
| Validation Page | [validation-page.jsx](designs/analyzer-integration/validation-page.jsx) | [validation-page.md](designs/analyzer-integration/validation-page.md) |
| HL7 MLLP Listener | — | [hl7-mllp-listener.md](designs/analyzer-integration/hl7-mllp-listener.md) |
...
| Feature | Mockup | Spec |
|---------|--------|------|
| Blood Bank Admin Config | [blood-bank-admin-config.jsx](designs/blood-bank/blood-bank-admin-config.jsx) | [blood-bank-admin-config.md](designs/blood-bank/blood-bank-admin-config.md) |
| Blood Unit Inventory | [blood-unit-inventory.jsx](designs/blood-bank/blood-unit-inventory.jsx) | [blood-unit-inventory.md](designs/blood-bank/blood-unit-inventory.md) |
| Patient Blood Bank Record | [patient-blood-bank-record.jsx](designs/blood-bank/patient-blood-bank-record.jsx) | [patient-blood-bank-record.md](designs/blood-bank/patient-blood-bank-record.md) |
...
| Issue to Patient & Emergency Release | [issue-to-patient.jsx](designs/blood-bank/issue-to-patient.jsx) · [preview](designs/blood-bank/issue-to-patient.html) | [issue-to-patient.md](designs/blood-bank/issue-to-patient.md) |
...
| Feature | Mockup | Spec |
|---------|--------|------|
| NCE Analytics | [nce-analytics.jsx](designs/nce/nce-analytics.jsx) | [nce-analytics.md](designs/nce/nce-analytics.md) |
| NCE Dashboard & CAPA | [nce-dashboard.jsx](designs/nce/nce-dashboard.jsx) | [nce-dashboard.md](designs/nce/nce-dashboard.md) |
| NCE Results Entry | [nce-results-entry.jsx](designs/nce/nce-results-entry.jsx) | [nce-results-entry.md](designs/nce/nce-results-entry.md) |
| NCE Report | [nce-report.jsx](designs/nce/nce-report.jsx) | [nce-report.md](designs/nce/nce-report.md) |

## Pathology

| Feature | Mockup | Spec |
|---------|--------|------|
| Pathology Case View *(superseded — see v2 below)* | [pathology-case-view.jsx](designs/pathology/pathology-case-view.jsx) | [pathology-case-view.md](designs/pathology/pathology-case-view.md) |
| IHC Case View *(superseded — see v2 below)* | [ihc-case-view.jsx](designs/pathology/ihc-case-view.jsx) | [ihc-case-view.md](designs/pathology/ihc-case-view.md) |
...
| **IHC Case View v2** (held) | [ihc-case-view-v2-mockup.jsx](designs/pathology/ihc-case-view-v2-mockup.jsx) · [preview](designs/pathology/ihc-case-view-v2-preview.html) | [ihc-case-view-v2.md](designs/pathology/ihc-case-view-v2.md) · [threshold seed review](designs/pathology/ihc-threshold-seed-review.md) |
...
| QA Menu v1 MVP (QI Dashboard) | [qa-v1-preview.html](designs/quality/qa-v1-preview.html) | [qa-v1-mvp-frs.md](designs/quality/qa-v1-mvp-frs.md) · [KPI rollup outline](designs/quality/qa-mvp-kpi-rollup-outline.md) · [QI dashboard outline](designs/quality/qi-dashboard-outline.md) · [rejection rate outline](designs/quality/qi-rejection-rate-outline.md) · [amendment rate outline](designs/quality/qi-amendment-rate-outline.md) |
| QA Menu v2 (E-Sig + Accreditation IA) | [qa-v2-preview.html](designs/quality/qa-v2-preview.html) | [e-sig log outline](designs/quality/electronic-signature-log-outline.md) · [accreditation status outline](designs/quality/accreditation-status-outline.md) · [CAPA register outline](designs/quality/capa-register-outline.md) |
| QA Menu — End State | [qa-final-preview.html](designs/quality/qa-final-preview.html) | [QA overview outline](designs/quality/qa-overview-outline.md) · [QI config outline](designs/quality/qi-configuration-outline.md) · [NCE dashboard v4](designs/quality/nce-dashboard-v4.0.md) · [sprint 4 prescoping](designs/quality/qi-sprint4-prescoping.md) |
| QA Westgard Phase 2 | [qa-westgard-phase2-preview.html](designs/quality/qa-westgard-phase2-preview.html) | [qa-westgard-phase2-frs.md](designs/quality/qa-westgard-phase2-frs.md) |
| Manual & RDT QC Persistence | — | [manual-rdt-qc-persistence.md](designs/quality/manual-rdt-qc-persistence.md) |
| QA Release Budget Calculator | [qa-release-budget-calculator.html](designs/quality/qa-release-budget-calculator.html) | [qa-release-plan.md](designs/quality/qa-release-plan.md) · [qa-sprint-plan.md](designs/quality/qa-sprint-plan.md) · [effort-estimate-with-claude.md](designs/quality/effort-estimate-with-claude.md) · [qa-menu-roadmap.md](designs/quality/qa-menu-roadmap.md) · [QMS expert review](designs/quality/qms-pillar-expert-review.md) · [Critical Callback outline](designs/quality/qi-critical-callback-compliance-outline.md) |
...
| Validation Clearance Rule & Empty-State | [validation-clearance-rule.jsx](designs/results-validation/validation-clearance-rule.jsx) · [preview](designs/results-validation/validation-clearance-rule.html) | [validation-clearance-rule.md](designs/results-validation/validation-clearance-rule.md) |
...
| TAT Report [Completed] | [tat-report.jsx](designs/reports/tat-report.jsx) | [tat-report.md](designs/reports/tat-report.md) |
...
| Reagent Forecasting Facility View [Superseded] | [reagent-forecasting-facility.jsx](designs/inventory/reagent-forecasting-facility.jsx) | [reagent-forecasting-facility.md](designs/inventory/reagent-forecasting-facility.md) |
...
| Feature | Mockup | Spec |
|---------|--------|------|
| Multiple Samples per Test at Order Entry [Completed] | [preview](designs/sample-collection/multi-sample-order-entry-preview.html) | [multi-sample-order-entry.md](designs/sample-collection/multi-sample-order-entry.md) |
...
| Sampling Site Registry [Completed] | [sampling-site-registry.jsx](designs/sample-collection/sampling-site-registry.jsx) | [sampling-site-registry.md](designs/sample-collection/sampling-site-registry.md) |
...
| Clinical Order Entry (v4) | [clinical-order-entry-v4.html](designs/sample-collection/clinical-order-entry-v4.html) | [order-entry-three-workflows.md](designs/sample-collection/order-entry-three-workflows.md) |
| Clinical Order Entry (v2) | [clinical-order-entry-v2.html](designs/sample-collection/clinical-order-entry-v2.html) | [order-entry-three-workflows.md](designs/sample-collection/order-entry-three-workflows.md) |
| Environmental Order Entry (v2) | [environmental-order-entry-v2.html](designs/sample-collection/environmental-order-entry-v2.html) | [order-entry-three-workflows.md](designs/sample-collection/order-entry-three-workflows.md) |
| Vector Collection Workflow (v2) | [vector-collection-workflow-v2.html](designs/vector-surveillance/vector-collection-workflow-v2.html) | [order-entry-three-workflows.md](designs/sample-collection/order-entry-three-workflows.md) |
...
| Feature | Mockup | Spec |
|---------|--------|------|
| TAT Dashboard [Completed] | [tat-dashboard.jsx](designs/other/tat-dashboard.jsx) | [tat-dashboard.md](designs/other/tat-dashboard.md) |
...
Detailed per-instrument integration specs and companion guides live in `specs/analyzer-instruments/`:

| Instrument | Integration Spec | Companion Guide | Vendor Manual |
|------------|-----------------|-----------------|---------------|
| Mindray BC-5380 | [Spec](specs/analyzer-instruments/mindray-bc5380/integration-spec.md) | [Guide](specs/analyzer-instruments/mindray-bc5380/companion-guide.md) | [PDF](assets/vendor-manuals/bc5380-lis-protocol.pdf) |
| Mindray BS Series | [Spec](specs/analyzer-instruments/mindray-bs-series/integration-spec.md) | [Guide](specs/analyzer-instruments/mindray-bs-series/companion-guide.md) | [PDF](assets/vendor-manuals/mindray-interface-specs-v5.pdf) |
| Stago ST4 | [Spec](specs/analyzer-instruments/stago-st4/integration-spec.md) | [Guide](specs/analyzer-instruments/stago-st4/companion-guide.md) | [PDF](assets/vendor-manuals/stago-start4-service-manual.pdf) |
| GeneXpert DX | [ASTM](specs/analyzer-instruments/genexpert-dx/astm-integration-spec.md), [HL7](specs/analyzer-instruments/genexpert-dx/hl7-integration-spec.md) | — | [PDF](assets/vendor-manuals/genexpert-lis-protocol-spec.pdf) |
| Finecare FS205 | — | [Guide](specs/analyzer-instruments/finecare-fs205/companion-guide.md) | [PDF](assets/vendor-manuals/finecare-lis-sop.pdf) |
| VIDAS | [Spec](specs/analyzer-instruments/vidas/integration-spec.md) | [Guide](specs/analyzer-instruments/vidas/companion-guide.md) | [PDF](assets/vendor-manuals/vidas-user-guide.pdf) |
| Indiko / Gallery | [Spec](specs/analyzer-instruments/indiko-gallery/integration-spec.md) | [Guide](specs/analyzer-instruments/indiko-gallery/companion-guide.md) | [PDF](assets/vendor-manuals/indiko-gallery-lis-interface.pdf) |
| MALDI Biotyper | [ASTM FRS](specs/analyzer-instruments/maldi-biotyper/astm-frs.md) | — | [PDF](assets/vendor-manuals/maldi-biotyper-astm-spec.pdf) |
...
| Document | Location |
|----------|----------|
| OpenELIS Features Overview | [DOCX](assets/research/openelis-features-overview.docx) |
| OpenELIS Features (French) | [DOCX](assets/research/openelis-features-overview-fr.docx) |
| Sample Aliquoting Requirements | [DOCX](assets/research/sample-aliquoting-requirements.docx) |
| ISO Standards Supported | [DOCX](assets/research/iso-standards-supported.docx) |
| Freezer Monitoring FRD | [DOCX](assets/requirements-docs/freezer-monitoring-frd.docx) |
| WHO Freezer Report Requirements | [DOCX](assets/requirements-docs/who-freezer-report-requirements.docx) |
