...
- **This run pushes a doc-only ledger sync** (`chore/ledger-reconcile-2026-07-28`) recording the #242 MERGED flip + the 5 portal drains + this entry; the auto-opener + required `test` check land it on green.
