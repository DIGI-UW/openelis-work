...
| chore/ledger-reconcile-2026-07-31 | https://github.com/DIGI-UW/openelis-work/compare/main...chore/ledger-reconcile-2026-07-31?expand=1 | 2026-07-31 | **OPEN** (verify MERGED next run) | Doc-only ledger sync: flips the 07-30 sync (#248) to MERGED and records the 2026-07-31 reconciliation (no new gallery artifacts; decision-log D-035…D-042 conflict unchanged; no Jira permalinks). |
