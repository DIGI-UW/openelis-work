...
| chore/ledger-reconcile-2026-08-03 | https://github.com/DIGI-UW/openelis-work/compare/main...chore/ledger-reconcile-2026-08-03?expand=1 | 2026-08-03 | **OPEN** (verify MERGED next run) | Doc-only ledger sync: flips the 07-31 sync to MERGED, records the 2026-08-03 reconciliation, and notes the decision-log-additions.md block fully landed (08-01 consolidation) + drained. No new gallery artifacts; no Jira permalinks. |
