...
| chore/ledger-reconcile-2026-08-17 | https://github.com/DIGI-UW/openelis-work/compare/main...chore/ledger-reconcile-2026-08-17?expand=1 | 2026-08-17 | **OPEN → auto-merge on green** (doc-only; connector `create_pull_request` attempted first — on 403 `Resource not accessible by integration` the branch is pushed with the PAT and the CI auto-opener + required `test` check land it) | Doc-only ledger sync: flips the 08-14 sync (PR #267) to MERGED, records the clean 2026-08-17 reconciliation (nothing new / upload-newer / genuinely-new), and flags two lingering side branches — superseded **PR #261** (`chore/ledger-reconcile-2026-08-11`) and the new un-tracked `design/ogc-782-separate-no-growth-release`. No design artifacts. Verify MERGED next run. |
