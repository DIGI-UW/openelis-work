...
| Flag | Icon | Color |
|------|------|-------|
| Above Normal | ↗ TrendingUp | Orange |
| Below Normal | ↘ TrendingDown | Yellow |
| Delta Check | ⚠ AlertTriangle | Red |
| Reagent Expiring | 🧪 FlaskConical | Amber |
| Control Failed | ⚠ AlertCircle | Red |
...
| Action | Icon | Description |
|--------|------|-------------|
| **Accept** | ✓ Check | Accept result (validates required fields) |
| **Note** | 💬 MessageSquare | Quick access to toggle note input (also available in Notes section) |
