...
export const MOCKUP_REGISTRY = [
  ...
  },
  {
    ...
    category: 'microbiology',
    component: null,
    description: 'Order Entry Step 1 amendment: when Program = MICROBIOLOGY, seven micro-specific fields appear inline (Culture Protocol, Patient Origin, Date of Admission, Number of Sets, Clinical History, Antibiotic Exposure, Critical Notify). Date of Admission supplies the missing input for the WHO GLASS hospital- vs community-origin classification.',
    ...
    status: 'draft',
    jira: ['OGC-789'],
    tags: ['microbiology', 'order-entry', 'mvp-1a', 'glass', 'surveillance'],
  },
  {
