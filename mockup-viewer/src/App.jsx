...
export const MOCKUP_REGISTRY = [
  ...
  // ─── Results & Validation ───
  {
    ...
    description: 'Unified Results Entry page (v3) — consolidates 6 legacy routes into /Results. Storage Location, Aliquots, Program Info, polymorphic Result cell (N/D/M), NCE-driven Result Disposition, inline Method/Order/Storage/Referral sections, e-signature on Save, Critical Acknowledgment routed to Alerts dashboard (Save NEVER blocked on ack — ack is a follow-up task). Optional CLSI GP47 structured form (opt-in, default OFF). Dual-axis note model (visibility × context). Cross-domain ready (CLINICAL / ENVIRONMENTAL / VECTOR via Lab Unit context).',
    specPath: 'designs/results-validation/results-page.md',
    htmlUrl: 'designs/results-validation/results-page.html',
    githubIssue: 36,
    jira: ['OGC-811', 'OGC-517'],
    tags: ['results', 'data-entry', 'workflow', 'entry', 'storage', 'nce', 'critical-ack', 'e-signature', 'v3', 'cross-domain'],
    added: '2026-03-03',
    updated: '2026-06-01',
    status: 'draft',
  },
  {
    ...
    description: 'Validation Page v3 — parity with Results Entry v3. Inline-first expanded panel (action bar at top, sections below, only QA/QC + History as tabs), Modification History banner, polymorphic Dictionary / Multi-Checkbox display, demographic-aware reference range Tag, dual-axis note model (visibility × context), e-signature on Release, stale-page conflict guard. Cross-domain ready (CLINICAL / ENVIRONMENTAL / VECTOR via Lab Unit context). Preserves OGC-343 multi-level pipeline and admin configuration unchanged.',
    specPath: 'designs/results-validation/validation-page.md',
    htmlUrl: 'designs/results-validation/validation-page.html',
    githubIssue: 37,
    jira: ['OGC-817', 'OGC-291', 'OGC-343'],
    tags: ['validation', 'results', 'review', 'approval', 'v3', 'cross-domain', 'e-signature', 'environmental', 'vector'],
    added: '2026-03-03',
    updated: '2026-06-01',
    status: 'draft',
  },
  {
    name: 'Admin: Validation Configuration',
    category: 'results-validation',
    component: React.lazy(() => import('@designs/results-validation/admin-validation-configuration.jsx')),
    description: 'Admin Validation Configuration v3 — refresh of OGC-343 to current standards. Lab-wide default + per-lab-unit overrides with Domain badge column (Clinical/Environmental/Vector), 0–5 sequential validation levels, permission-filtered role dropdowns, three Trigger modes (No Results / All Results / Abnormal Only), domain-aware default suggestions, live Effective-Config Preview, useMultiLevelValidation feature flag, schema reuse over existing Analysis.statusId + Audit. Companion to OGC-817 Validation Page v3.',
    specPath: 'designs/results-validation/admin-validation-configuration.md',
    htmlUrl: 'designs/results-validation/admin-validation-configuration.html',
    jira: ['OGC-343', 'OGC-817', 'OGC-579'],
    tags: ['admin', 'validation', 'configuration', 'multi-level', 'cross-domain', 'v3', 'feature-flag', 'results-validation'],
    added: '2026-06-10',
    updated: '2026-06-10',
    status: 'draft',
  },
  ...
  },
  {
    ...
    description: 'Laporan Hasil (S-06) — formal Sertifikat Hasil Uji PDF generation for validated environmental orders. Dual e-signature, batch ZIP download, shared Report Print Configuration admin page. 2026-04-28 amendment: header lists all selected regulations (M:N); result table renders per-component values with per-regulation compliance indicators.',
  ...
  },
  {
    ...
    description: 'Push-based print queue for validated patient reports — auto-surfaces unprinted accessions with batch print, per-report critical indicator, ISO 15189 audit trail via existing DocumentTrack + History infrastructure. FRS v1.1 reuses system_module / system_role_module for access control and Envers for audit coverage.',
    specPath: 'designs/reports/patient-report-print-queue.md',
    htmlUrl: 'designs/reports/patient-report-print-queue.html',
    added: '2026-03-18',
    updated: '2026-06-09',
    status: 'draft',
    githubIssue: 54,
    jira: [],
    tags: ['reports', 'print', 'queue', 'patient-report', 'audit', 'iso-15189'],
  },
  {
