...
export const MOCKUP_REGISTRY = [
  ...
  // ─── Results & Validation ───
  {
    ...
    description: 'Unified Results Entry page (v3) — consolidates 6 legacy routes into /Results, adds Storage Location, polymorphic Result cell (N/D/M), NCE-driven Result Disposition, inline Method/Order/Storage/Referral sections, e-signature on Save, Critical Acknowledgment to Alerts dashboard.',
    specPath: 'designs/results-validation/results-page.md',
    htmlUrl: 'designs/results-validation/results-page.html',
    githubIssue: 36,
    jira: ['OGC-517'],
    tags: ['results', 'data-entry', 'workflow', 'entry', 'storage', 'nce', 'critical-ack', 'e-signature', 'v3'],
    added: '2026-03-03',
    updated: '2026-05-28',
    status: 'draft',
  },
  {
    ...
    description: 'Result validation workflow (v3) — inline-first expanded panel, Modification History banner, CLSI GP47 Critical Notification Display, polymorphic D/M result display, demographic-aware ranges, e-signature on release, stale-page conflict guard, dual-axis note model (visibility × context). Preserves OGC-343 multi-level pipeline + admin config.',
    ...
    tags: ['validation', 'results', 'review', 'approval', 'environmental', 'vector', 'v3', 'e-signature', 'gp47'],
    added: '2026-03-03',
    updated: '2026-05-30',
    status: 'draft',
  },
