...
export const MOCKUP_REGISTRY = [
  ...
  {
    name: 'Test Catalog Editor — Completion & Correction [Completed]',
    category: 'admin-config',
    archived: true,
  ...
  {
    name: 'Test Catalog Completion v2 [Completed]',
    category: 'admin-config',
    archived: true,
  ...
  {
    name: 'Test Catalog — QC Targets & LOD/LOQ',
    category: 'admin-config',
    component: null,
    description: 'New QC Targets section in the Test Catalog unified editor: expected value ± uncertainty per control level (Low/Normal/High) with per-lot overrides linking existing qc_control_lot records; prefill contract for Results Entry control capture (lot override → level default → blank); plus LOD/LOQ fields per result component in Sample & Results (validated LOD ≤ LOQ). Interactive preview renders both touched sections in editor context.',
    specPath: 'designs/admin-config/test-catalog-qc-targets.md',
    htmlUrl: 'designs/admin-config/test-catalog-qc-targets-preview.html',
    added: '2026-07-24',
    status: 'draft',
    githubIssue: 241,
    jira: ['OGC-1148', 'OGC-1147'],
    tags: ['test-catalog', 'qc-targets', 'lod-loq', 'quality', 'prefill', 'admin', 'configuration'],
  },
  {
  ...
  {
    name: 'Barcode Configuration [Completed]',
    category: 'admin-config',
    archived: true,
  ...
  {
    name: 'Barcode Labels v2 [Completed]',
    category: 'admin-config',
    archived: true,
  ...
  {
    name: 'Panel Management [Completed]',
    category: 'admin-config',
    archived: true,
  ...
  {
    name: 'Test Catalog v2.5 — v1 Jira Story Breakdown [Superseded]',
    category: 'admin-config',
    archived: true,
    component: null,
  ...
  {
    name: 'Test Catalog v2.5 — v2 Jira Story Breakdown [Superseded]',
    category: 'admin-config',
    archived: true,
    component: null,
  ...
  {
    name: 'Compliance Standards Administration [Completed]',
  ...
  {
    name: 'Sample Type Management [Completed]',
    category: 'admin-config',
    archived: true,
  ...
  {
    name: 'Sample Type Domain Classification [Completed]',
    category: 'vector-surveillance',
    archived: true,
  ...
  {
    name: 'Sample Type Multi-Domain Addendum [Completed]',
    category: 'admin-config',
    archived: true,
    component: null,
    ...
    relatedTo: ['Sample Type Domain Classification [Completed]'],
  ...
  },
  {
    ...
    status: 'draft',
    githubIssue: 97,
    relatedTo: ['Test Catalog [Completed]', 'Report Print Queue', 'Patient Report Redesign'],
  ...
  },
  {
    ...
    status: 'draft',
    githubIssue: 98,
    relatedTo: ['Test Catalog [Completed]', 'Range Editor'],
  ...
  },
  {
    ...
    description: 'Programs admin rework (v2, consolidated) — Domain (Clinical/Environmental/Vector) field matching Test Catalog & Lab Units; moves under Admin → Test Management; inline Edit/Add (no separate page); Deactivate/Reactivate lifecycle (no hard delete) with a Show-deactivated toggle; Carbon ContentSwitcher (Visual Builder ↔ JSON) with a live "Example" preview; multi Lab-unit select; heavy on-screen guidance; API & i18n reuse guardrails. Also FR-28 (one builder, per-context SideNav submenu: Programs / per-domain Order form fields / Patient form fields) and FR-29 (shipped fields: badge + Visible toggle, hide-not-delete, not deletable, excluded from the JSON view, Site-Information fields locked, hidden rows collapse). FR-13.1 adds Move up/Move down controls on each Question card (keyboard-reachable, disabled-not-hidden at ends; reorders Questionnaire.item[] without renumbering linkIds, preserving existing responses). Epic: OGC-781.',
  ...
  {
    name: 'Patient & Order Additional Information — Surveillance / HIV-PMTCT (appendix)',
    category: 'admin-config',
    component: React.lazy(() => import('@designs/admin-config/patient-additional-info-surveillance-pmtct.jsx')),
    description: 'Field-catalog appendix to the Programs Management rework (OGC-781), which owns the build. Holds the Madagascar content: Section G (existing patient Additional Information fields folded in), Section A — Disease Surveillance (A1–A10: signs & symptoms, onset date, case classification, epidemiological link, travel to endemic region, dates of stay, medical history, comorbidity, prior vaccination), and Section B — HIV/PMTCT–EID (B1–B14: mother patient-link, mother HIV status, ARV during pregnancy, treatment type, maternal viral load + copies/ml, breastfeeding + weaning durations, reason for request, at-risk population, ARV start date, treatment received). Carries per-field patient-level vs order-level placement, the six Dictionary categories to seed, and the FHIR mapping table. Note: this document’s earlier standalone sections/field-type/inline-options admin surface is SUPERSEDED by OGC-781’s questionnaire builder — read it as content, not as a competing mechanism spec.',
  ...
  {
    name: 'QuantStudio 5/7 Flex Field Mapping [Completed]',
    category: 'analyzer-integration',
    archived: true,
    component: null,
    ...
    jira: ['OGC-348'],
    added: '2026-03-06',
    relatedTo: ['QuantStudio 5/7 Flex Companion Guide [Completed]'],
    githubIssue: 16,
    tags: ['analyzer', 'QuantStudio', 'PCR', 'HIV', 'field-mapping'],
  },
  {
    name: 'QuantStudio 5/7 Flex Companion Guide [Completed]',
    category: 'analyzer-integration',
    archived: true,
    component: null,
    ...
    jira: ['OGC-348'],
    added: '2026-03-06',
    relatedTo: ['QuantStudio 5/7 Flex Field Mapping [Completed]'],
    githubIssue: 17,
  ...
  {
    name: 'Analyzer Mapping Templates [Completed]',
    category: 'analyzer-integration',
    archived: true,
  ...
  {
    name: 'Flat File Analyzer Config [Completed]',
    category: 'analyzer-integration',
    archived: true,
  ...
  {
    name: 'HL7 Analyzer Mapping [Completed]',
    category: 'analyzer-integration',
    archived: true,
  ...
  // ─── Microbiology — M-* bundle (supersedes OGC-293 / amr-module) ───
  {
    ...
    component: null,
    description: 'Spine spec for the M-* bundle: glossary, RBAC matrix, data model overview, phase plan, out-of-scope, v1.1 → v2 diff map. v2.1: NO_GROWTH_FINAL → NO_GROWTH_READY (releases to FINAL_REPORTED, not terminal).',
  ...
  },
  {
    ...
    tags: ['microbiology', 'glass', 'surveillance', 'amr', 'whonet', 'national'],
  },
  {
    ...
    status: 'draft',
    jira: ['OGC-918'],
    tags: ['microbiology', 'glass', 'surveillance', 'aspect', 'scoping'],
  },
  {
  ...
  },
  {
    ...
    category: 'microbiology',
    component: null,
    description: 'Clickable end-to-end case workup \u2014 start inoculation, add/identify isolates, set up + receive AST, log critical, release reports; stage, sidebar and next-step guidance update live; opens on the current step. v2.1: release gate keys on a recorded outcome (isolate workup complete / no growth / all-contaminant / TB CONTAMINATED|NTM_IDENTIFIED), NO_GROWTH_FINAL to NO_GROWTH_READY.',
    specPath: 'designs/microbiology/m-04-case-workbench-core.md',
...

  {
    ...
    category: 'microbiology',
    component: null,
    description: 'The M-04 Case Workbench shell as a TB profile: smear, MGIT/LJ culture, species ID, critical-concentration DST, molecular flags, staged interim reports. v1.1 aligns the TB bench with the no-growth amendment (NO_GROWTH_READY + release; CONTAMINATED is not a result).',
  ...
  {
    name: 'Case View Shell',
    category: 'pathology',
    component: null,
    description: 'The shared structural contract (S-1 \u2026 S-10) implemented by the Pathology, IHC and Cytology case views: PatientHeader, prior related results, accordion sections, the four-state section model, the optional progress rail, the sticky Case Summary, the status-and-role-driven action bar, status transitions, the critical-result hook, and identified objects with no hard delete. Carries a per-screen conformance table \u2014 an adopting screen may not silently omit an element.',
    specPath: 'designs/pathology/case-view-shell.md',
    githubIssue: 295,
    added: '2026-09-04',
    status: 'draft',
    tags: ['pathology', 'cytology', 'IHC', 'shell', 'shared-contract', 'cross-cutting', 'v2'],
  },
  {
    name: 'Pathology Case View v2',
    category: 'pathology',
    component: React.lazy(() => import('@designs/pathology/pathology-case-view-mockup.jsx')),
    description: 'Rebuilds the histopathology case-detail screen around the real bench stages, reworking PathologyStatus to eleven values. Cassette and block become one row with a continuous identity, every slide references its parent block, reconciliation is computed over rows rather than typed, and slide labels are scan-verified against the block before sectioning \u2014 the transition where published work puts 52% of all mislabelling. Supersedes the December 2025 design. Ships with a slicing guide and a contributor handoff.',
    specPath: 'designs/pathology/pathology-case-view-v2.md',
    htmlUrl: 'designs/pathology/pathology-case-view-v2-preview.html',
    githubIssue: 296,
    added: '2026-09-04',
    status: 'draft',
    tags: ['pathology', 'histology', 'biopsy', 'case-management', 'traceability', 'barcode', 'ISO-15189', 'v2'],
  },
  {
    name: 'IHC Case View v2',
    category: 'pathology',
    component: React.lazy(() => import('@designs/pathology/ihc-case-view-v2-mockup.jsx')),
    description: 'Moves every interpretive threshold out of application code into versioned, source-stamped reference data resolved on a composite key (marker, clone, assay/platform, scoring system, tumour type, indication). Each result stores its raw measurement alongside the set that interpreted it, and the set\u2019s source and edition render beside the category. HER2 IHC stays four distinct values 0/1+/2+/3+; ISH has no equivocal category; Ki-67 5\u201330% reports as indeterminate rather than being forced to a binary. HELD from implementation pending the threshold-set mechanism.',
    specPath: 'designs/pathology/ihc-case-view-v2.md',
    htmlUrl: 'designs/pathology/ihc-case-view-v2-preview.html',
    githubIssue: 297,
    added: '2026-09-04',
    status: 'draft',
    tags: ['pathology', 'IHC', 'immunohistochemistry', 'HER2', 'ER-PgR', 'Ki-67', 'thresholds', 'reference-data', 'held', 'v2'],
  },
  {
    name: 'Specimen Journey',
    category: 'pathology',
    component: null,
    description: 'Developer orientation, not a screen design. Follows one fictional patient through all three anatomic-pathology benches \u2014 cytology, histopathology, IHC \u2014 explaining what physically happens to the tissue, who touches it, and where each screen sits. Includes SVG diagrams of the nine-stage journey with its real PathologyStatus values, and of the case \u2192 part \u2192 block \u2192 slide hierarchy. Read this before the three case-view specs; they assume it.',
    htmlUrl: 'designs/pathology/specimen-journey.html',
    githubIssue: 298,
    added: '2026-09-04',
    status: 'draft',
    tags: ['pathology', 'cytology', 'IHC', 'orientation', 'onboarding', 'diagrams', 'developer-guide'],
  },
  ...
  {
    name: 'Manual & RDT QC Persistence',
    category: 'quality',
    component: null,
    description: 'Source-typed QC result persistence (ASTM / MANUAL / RDT) for non-analyzer control results: QC target consumption with snapshot-on-capture, the Validation QC-fail signal (V1), and Statistical QC pillar integration (dashboard source filter, Levey-Jennings participation for manual quantitative). Schema decisions D1–D5 are build-time, owned by the implementer. Unblocks Results Entry R6 control capture (OGC-1025) and makes the Manual QC placeholder leaf (OGC-692) real.',
    specPath: 'designs/quality/manual-rdt-qc-persistence.md',
    added: '2026-07-24',
    status: 'draft',
    githubIssue: 240,
    jira: ['OGC-1147', 'OGC-1025', 'OGC-692'],
    tags: ['quality', 'QC', 'manual-qc', 'RDT', 'westgard', 'persistence', 'validation-signal'],
  },
  {
  ...
  {
    name: 'Results Entry v4 [Superseded]',
    project: ['png'],
  ...
  {
    name: 'Validation Page v4 [Superseded]',
    project: ['png'],
    category: 'results-validation',
    archived: true,
    component: null,
  ...
  {
    name: 'Runs — QC, Reagent Lot & Result Review',
    category: 'results-validation',
    component: React.lazy(() => import('@designs/results-validation/runs.jsx')),
    description: 'The run as the shared unit of QC, reagent-lot provenance and result review across all three ways results enter OpenELIS: analyzer messages, workplan batches, and single manual entries. Every result belongs to a run; controls, the reagent lot and a per-test QC verdict live on the run. Converges the Analyzer Results Import review onto the Results worklist as a run-filtered view (/Results?run=<id>) with a run header, defines run-aware worklist row states (waiting/held), and a per-test QC gate (a failed potassium control holds only that test’s rows). States the consumption contracts for QC persistence (OGC-1147), Batch Workplan (OGC-427), the QC dashboard, and Validation. FRS v0.4 (2026-09-22), approved for handoff — simplifies the review surface on Casey’s direction: a single paginated run table driven by the worklist’s existing filter chips (FR-E1a/E1b), each row expanding into the Results Entry panel with the analyzer value prefilled and editable (FR-E10), the Accept contract corrected against D-057, and the Validation contract routed to the clearance rule’s row QC slot (FR-G3). Supersedes-in-part Analyzer Import v2 (OGC-288), Batch Workplan reagent QC (OGC-427), and Manual/RDT QC persistence (OGC-1147) FR-C1.',
    specPath: 'designs/results-validation/runs.md',
    htmlUrl: 'designs/results-validation/runs-preview.html',
    jira: ['OGC-288', 'OGC-427', 'OGC-1147', 'OGC-1178', 'OGC-811', 'OGC-1131'],
    added: '2026-09-09',
    updated: '2026-09-22',
    status: 'draft',
    githubIssue: null,
    tags: ['runs', 'qc', 'quality-control', 'reagent-lot', 'analyzer', 'workplan', 'rdt', 'results-worklist', 'holds', 'westgard', 'accreditation'],
  },
  {
  ...
  },
  {
    ...
    description: 'OpenELIS CSV reporting design with new-export and saved-report entry paths, a searchable catalog with expandable category groups beside ordered CSV columns, progressive filters, review changes, queue recovery and a fictional virology CSV. v1.5 interaction candidate for review; independent of Catalyst and AI.',
  ...
  },
  {
    ...
    relatedTo: ['Calendar Management [Completed]', 'TAT Dashboard [Completed]'],
  },
  ...
  // ─── Inventory ───
  {
    ...
    status: 'draft',
    githubIssue: 60,
    relatedTo: ['Reagent Forecasting Facility View [Superseded]'],
  ...
  {
    name: 'Reagent Forecasting Facility View [Superseded]',
    category: 'inventory',
    archived: true,
  ...
  {
    name: 'Analyzer Import [Superseded]',
    category: 'system',
  ...
  {
    name: 'Combined Collections at Order Entry [Superseded]',
    category: 'sample-collection',
    archived: true,
    component: null,
    description: 'Combined-collection mode for a sample group at Add Order: several recorded collection events assemble into ONE specimen with a summed total volume and an explicit collection window (a 24-hour urine arriving in four bottles is one specimen, not four), rather than one specimen per collection. A result still points at exactly one specimen, so analysers, referral messages and reports all continue to see one specimen with one result. Deliberately excludes cross-patient pooling (OGC-527) and result computation — it captures the total volume and window a calculation needs and leaves the math to the test config. The deferred second half of Multiple Samples per Test at Order Entry (v1 tests each collection separately; v2 combines them). Affects Add Order (/SamplePatientEntry), Edit Order, specimen labels, result-entry display, patient report. FRS v2.0 — WITHDRAWN 2026-08-12 (superseded before review by the merged Derived & Calculated Results spec, which will own both the collection capture and the calculation that consumes it; kept for the record). HTML preview.',
    specPath: 'designs/sample-collection/combined-collections-order-entry.md',
    htmlUrl: 'designs/sample-collection/combined-collections-order-entry-preview.html',
    added: '2026-08-12',
    updated: '2026-08-13',
    status: 'draft',
    githubIssue: null,
    jira: ['OGC-285'],
    tags: ['order-entry', 'sample-collection', 'specimen', 'combined-collection', '24h-urine', 'pooled-single-patient', 'labels', 'add-order'],
  },
  {
  ...
  {
    name: 'Sampling Site Registry [Completed]',
    category: 'vector-surveillance',
    archived: true,
  ...
  },
  {
    ...
    category: 'vector-surveillance',
    component: null,
    description: 'Clinical Enter Order stage under Order Entry FRS v4. Explicit save model (Save & Next / Save & Exit / Discard, no autosave), lab number reserved on form load, restored Ward / Unit / Department typeahead disabled until a facility is chosen, restored Order Date plus the new Order Time alongside Required By with distinguishing helper text, and the corrected saved-state indicator which reads \u201cNo changes yet\u201d on an untouched form rather than \u201cSaved\u201d. Interactive: edit a field to move the state chip, clear the facility to disable the ward field, press Discard for the confirmation naming the spent lab number.',
    specPath: 'designs/sample-collection/order-entry-three-workflows.md',
    htmlUrl: 'designs/sample-collection/clinical-order-entry-v4.html',
    added: '2026-09-10',
    status: 'draft',
    jira: ['OGC-1146', 'OGC-1066'],
    githubIssue: 311,
    tags: ['clinical', 'order-entry', 'sample-collection', 'save-model', 'lab-number', 'requester', 'ward', 'order-date'],
  },
  {
  ...
  {
    name: 'Informed Consent Capture [Completed]',
    category: 'sample-collection',
    archived: true,
  ...
  {
    name: 'Calendar Management [Completed]',
    category: 'other',
    archived: true,
  ...
  {
    name: 'Patient ID Card Scanning [Completed]',
    category: 'patient',
    archived: true,
...
const PERMALINK_ALIASES = {
  // Archived 2026-09-04 — delivered / superseded entries renamed with a status marker.
  'admin-config/test-catalog': 'admin-config/test-catalog-completed',
  'admin-config/test-catalog-editor-completion-correction': 'admin-config/test-catalog-editor-completion-correction-completed',
  'admin-config/test-catalog-completion-v2': 'admin-config/test-catalog-completion-v2-completed',
  'admin-config/test-catalog-specimen-many-to-many': 'admin-config/test-catalog-specimen-many-to-many-completed',
  'admin-config/panel-management': 'admin-config/panel-management-completed',
  'admin-config/sample-type-management': 'admin-config/sample-type-management-completed',
  'admin-config/sample-type-multi-domain-addendum': 'admin-config/sample-type-multi-domain-addendum-completed',
  'admin-config/barcode-configuration': 'admin-config/barcode-configuration-completed',
  'admin-config/barcode-labels-v2': 'admin-config/barcode-labels-v2-completed',
  'other/calendar-management': 'other/calendar-management-completed',
  'reports/tat-report': 'reports/tat-report-completed',
  'other/tat-dashboard': 'other/tat-dashboard-completed',
  'patient/patient-id-card-scanning': 'patient/patient-id-card-scanning-completed',
  'sample-collection/informed-consent-capture': 'sample-collection/informed-consent-capture-completed',
  'sample-collection/multiple-samples-per-test-at-order-entry': 'sample-collection/multiple-samples-per-test-at-order-entry-completed',
  'analyzer-integration/quantstudio-5-7-flex-field-mapping': 'analyzer-integration/quantstudio-5-7-flex-field-mapping-completed',
  'analyzer-integration/quantstudio-5-7-flex-companion-guide': 'analyzer-integration/quantstudio-5-7-flex-companion-guide-completed',
  'analyzer-integration/flat-file-analyzer-config': 'analyzer-integration/flat-file-analyzer-config-completed',
  'analyzer-integration/hl7-analyzer-mapping': 'analyzer-integration/hl7-analyzer-mapping-completed',
  'analyzer-integration/analyzer-mapping-templates': 'analyzer-integration/analyzer-mapping-templates-completed',
  'vector-surveillance/compliance-standards-administration': 'vector-surveillance/compliance-standards-administration-completed',
  'vector-surveillance/sampling-site-registry': 'vector-surveillance/sampling-site-registry-completed',
  'vector-surveillance/sample-type-domain-classification': 'vector-surveillance/sample-type-domain-classification-completed',
  'results-validation/results-entry-v4': 'results-validation/results-entry-v4-superseded',
  'results-validation/validation-page-v4': 'results-validation/validation-page-v4-superseded',
  'inventory/reagent-forecasting-facility-view': 'inventory/reagent-forecasting-facility-view-superseded',
  'system/analyzer-import': 'system/analyzer-import-superseded',
