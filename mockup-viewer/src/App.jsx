...
export const MOCKUP_REGISTRY = [
  ...
  },
  {
    ...
    category: 'reports',
    component: null,
    description: 'Full redesign of the patient result report — Carbon-aligned layout with accreditation logo rendering, digital signature block, reference range display, result interpretation flagging, and JasperReports JRXML template. Covers both the admin configuration surface and the rendered output spec.',
    ...
    tags: ['reports', 'patient-report', 'print', 'accreditation', 'jasper', 'iso-15189'],
  },
  {
  ...
  },
  {
    ...
    description: 'S-03d Addendum to S-03 (OGC-537) — General "Required By" date+time field on Order Entry Step 1 for all order types (reusing EQA DatePicker pattern; unifies eqa_deadline into order.required_by). ENV/Vector-specific SOP holding time auto-calculation: computes testing deadline from collection date + minimum sop_max_holding_hours across tests; live suggestion with most-restrictive-test annotation and manual override. Admin: SOP Max Holding Time per test in Test Catalog Management (inline row expansion). ENV/Vector worklist Deadline column: green/amber/red tags, relative time, WarningAlt icon, Approaching/Overdue filter chips, configurable approach threshold.',
    ...
    githubIssue: 89,
    jira: ['OGC-537', 'OGC-527'],
    tags: ['order-entry', 'SOP', 'deadline', 'holding-time', 'environmental', 'vector', 'EQA', 'worklist', 'Indonesia', 'SILNAS', 'Bogor', 'ISO-17025'],
  },
  {
