...
import { Add, Edit, ChevronDown, ChevronUp, Save, Renew, Search, View, Close, Locked } from '@carbon/icons-react';
          ...
          {selectedStandard && (
            <Tile>
              ...
              {showSampleTypeOverride ? (
                ...
                <Button kind="ghost" size="sm" renderIcon={Add} onClick={() => setShowSampleTypeOverride(true)}>
